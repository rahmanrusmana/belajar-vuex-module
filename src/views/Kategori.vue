<template> 
<p class="text-5xl text-gray-900 dark:text-white text-center font-semibold">Kategori Produk</p>
<div class="grid grid-cols-2 m-5">
  <div class="flex flex-container" v-for="kategori in getKategori" :key="index">
